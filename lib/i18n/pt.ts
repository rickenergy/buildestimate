...
export const pt: Dict = {
  ...
  newflow: {
    chooseTitle: "O que você quer começar?",
    startResidential: "Estimate residencial",
    startResidentialDesc: "Um trabalho em casa — reforma, reparo, ampliação.",
    startCommercial: "Estimate comercial",
    startCommercialDesc: "Um trabalho comercial — código, alvarás, retenção.",
    startProject: "Novo projeto",
    startProjectDesc: "Um recipiente para vários trabalhos de um cliente ou obra.",
    types: { residential: "Estimate residencial", commercial: "Estimate comercial" } as Record<string, string>,
    typeSubtitle: {
      residential: "Trabalho em casa. O assessor adapta perguntas e regras ao residencial.",
      commercial: "Trabalho comercial. Valem código, alvarás, seguros e pagamentos mais rígidos.",
    } as Record<string, string>,
    materialsQ: "O material está incluído no estimate?",
    materialsHint: "Desligado = o cliente fornece o material. Muda o que o assessor pergunta.",
    rulesTitle: "Regras e exigências deste tipo",
    code: "Base de código",
    permit: "Alvará e inspeções",
    payment: "Cronograma de pagamento",
    retainage: "Retenção",
    prereqs: "Pré-requisitos",
    risks: "Riscos a precificar",
    suggests: "Sugerido: {margin}% margem · {contingency}% contingência",
    advisorTitle: "Assessor — perguntas para a obra",
    advisorHint: "Leia para quem toca a obra e capture tudo antecipadamente.",
    answerPlaceholder: "Resposta / notas…",
    categories: {
      scope: "escopo",
      site: "local",
      materials: "material",
    ...
    projectNamePlaceholder: "ex. Reforma rua Maple",
    projectType: "Tipo",
    projectTypes: { residential: "Residencial", commercial: "Comercial", mixed: "Misto" } as Record<string, string>,
    client: "Cliente (opcional)",
    clientPlaceholder: "Nome do cliente ou empresa",
    address: "Endereço (opcional)",
    addressPlaceholder: "Rua, cidade, estado",
    ...
    state: "Estado",
    zip: "CEP/ZIP",
    addressAutofillHint: "Comece a digitar o endereço — escolha uma sugestão e cidade, estado e ZIP preenchem sozinhos.",
    projectsTitle: "Projetos",
    projectsSubtitle: "Agrupe vários trabalhos sob um projeto e obra.",
    newProject: "Novo",
    noProjects: "Nenhum projeto ainda",
    noProjectsHint: "Crie um projeto para agrupar trabalhos de um cliente ou obra.",
    jobs: "trabalhos",
    contractTotal: "Total do contrato",
    jobsInProject: "Trabalhos neste projeto",
    addJob: "Adicionar trabalho",
    noJobs: "Sem trabalhos ainda — adicione o primeiro.",
  },
  ...
  prices: {
    ...
    dupWarning: "Já existe em {trade} → toque para ver",
